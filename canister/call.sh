...
dfx canister --network=ic --wallet t35f6-tiaaa-aaaai-acewq-cai uninstall-code live_detect
...
dfx canister --network ic call live_detect claimNFT '(principal "r2a3n-etwya-gh4cb-4xhax-rcndg-guats-vbwis-w3q6v-4svgz-uf53c-mae")'
